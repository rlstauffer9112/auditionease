...
export const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onSelectPlan }) => {
  return (
    <div className="min-h-screen bg-[#E0E7FF] text-[#1A1A1A] font-sans selection:bg-[#4F46E5] selection:text-white">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <span className="max-[399px]:hidden text-lg sm:text-xl font-bold tracking-tight text-[#1A1A1A]">AuditionEase</span>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-3 shrink-0">
            <button
              ...
              className="text-[#4F46E5] px-3 sm:px-5 py-2.5 rounded-full font-bold text-sm hover:bg-indigo-50 transition-all"
            >
              Log In
            </button>
            <button
              onClick={onGetStarted}
              className="bg-[#4F46E5] text-white px-4 sm:px-6 py-2.5 rounded-full font-bold text-sm hover:bg-[#4338CA] transition-all active:scale-95 shadow-lg shadow-indigo-100"
            >
              Get Started
            </button>
          </div>
      ...
      <section className="relative pt-28 sm:pt-40 pb-20 sm:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <motion.div
            ...
            className="px-6"
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 border border-indigo-100 text-[#4F46E5] text-xs font-bold uppercase tracking-widest mb-8 sm:mb-12">
              <Star size={14} className="text-yellow-500" />
              The Future of Auditions is Here
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-8xl font-black tracking-tighter uppercase mb-8 leading-[0.9] text-[#1A1A1A]">
              Every<br />
              <span className="text-[#4F46E5]">Audition</span><br />
              Simplified
            </h1>

            <p className="max-w-2xl text-lg md:text-xl text-gray-600 mb-8 sm:mb-12 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <button
                onClick={onGetStarted}
                className="w-full sm:w-auto bg-[#4F46E5] text-white px-8 sm:px-10 py-4 sm:py-5 rounded-2xl font-black text-lg hover:bg-[#4338CA] transition-all hover:scale-105 active:scale-95 shadow-2xl shadow-indigo-500/20 flex items-center justify-center gap-3"
              >
                Create Free Account
                <ArrowRight size={24} />
              </button>
              <button className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 rounded-2xl font-bold text-lg border border-indigo-100 hover:bg-indigo-50 transition-all">
                See Sample Audition
              </button>
            </div>
          </motion.div>
      ...
      <section id="features" className="py-20 sm:py-32 px-6 bg-white text-black">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 sm:mb-20">
            ...
            <p className="text-lg sm:text-xl text-black/60 max-w-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                key={i}
                whileHover={{ y: -10 }}
                className="p-6 sm:p-8 rounded-3xl bg-[#F9FAFB] border border-[#E5E7EB] hover:shadow-2xl transition-all"
              >
      ...
      <section id="how-it-works" className="py-20 sm:py-32 px-6 bg-[#E0E7FF] overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              <h2 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tighter uppercase mb-8 sm:mb-12 text-[#1A1A1A]">
                Simple <br />
              ...
              <div className="space-y-8 sm:space-y-12">
                {[
                  ...
                  <div key={i} className="flex gap-5 sm:gap-8">
                    <span className="shrink-0 text-4xl sm:text-5xl font-black text-[#4F46E5] opacity-20">{item.step}</span>
                    <div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white border border-indigo-100 rounded-[40px] p-6 sm:p-8 overflow-hidden shadow-2xl shadow-indigo-100">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 sm:py-32 px-6 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto items-stretch">
            ...
            <motion.div
              whileHover={{ y: -10 }}
              className="p-7 sm:p-10 rounded-[40px] bg-[#E0E7FF] border border-indigo-100 flex flex-col shadow-sm"
            >
              <div className="mb-8">
            ...
            <motion.div
              whileHover={{ y: -10 }}
              className="p-7 sm:p-10 rounded-[40px] bg-[#4F46E5] border border-[#4F46E5] flex flex-col relative overflow-hidden shadow-2xl shadow-indigo-200"
            >
            ...
            <motion.div
              whileHover={{ y: -10 }}
              className="p-7 sm:p-10 rounded-[40px] bg-[#1A1A1A] border border-gray-800 flex flex-col relative overflow-hidden shadow-2xl shadow-gray-300"
            >
      ...
      <section id="testimonials" className="py-20 sm:py-32 px-6 bg-[#E0E7FF] text-black border-t border-indigo-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-20">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase mb-6">
              Loved by <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-7 sm:p-10 rounded-[40px] bg-[#F3F4F6] border border-[#E5E7EB] relative">
                <div className="absolute top-7 right-7 sm:top-10 sm:right-10 text-[#4F46E5] opacity-10">
                  <ClipboardList size={64} />
                </div>
                <p className="text-lg sm:text-xl font-medium mb-8 relative z-10 italic">"{testimonial.quote}"</p>
                <div>
      ...
      <section className="py-20 sm:py-32 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto bg-[#4F46E5] rounded-[40px] sm:rounded-[60px] px-6 py-12 sm:p-12 md:p-24 text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 blur-[80px] rounded-full -mr-32 -mt-32" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-black/20 blur-[80px] rounded-full -ml-32 -mb-32" />
          
          <h2 className="text-3xl sm:text-4xl md:text-7xl font-black tracking-tighter uppercase mb-8 relative z-10">
            Ready to <br />Simplify Your Auditions?
          </h2>
          <p className="text-lg sm:text-xl text-white/80 mb-8 sm:mb-12 max-w-xl mx-auto relative z-10">
            Join directors and organizations who have transformed their audition process with AuditionEase.
          </p>
          <button 
            onClick={onGetStarted}
            className="bg-white text-[#4F46E5] w-full sm:w-auto px-8 sm:px-12 py-5 sm:py-6 rounded-2xl font-black text-lg sm:text-xl hover:bg-white/90 transition-all hover:scale-105 active:scale-95 relative z-10"
          >
      ...
      {/* Footer */}
      <footer className="py-12 sm:py-20 px-6 border-t border-indigo-100 bg-white">
