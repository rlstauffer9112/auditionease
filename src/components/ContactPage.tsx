  ...
  return (
    <div className="min-h-screen bg-white text-[#1A1A1A] font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-24 sm:pt-32 pb-16 sm:pb-20">
        ...
        <p className="text-gray-400 mb-8 sm:mb-12">We're here to help. Reach out to us with any questions or concerns.</p>

        <div className="space-y-8 text-[#374151] leading-relaxed">
          <section className="bg-[#F9FAFB] rounded-2xl p-5 sm:p-8">
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="min-w-0">
                ...
                <a href="mailto:support@auditionease.com" className="text-[#4F46E5] hover:underline font-semibold text-lg mt-2 inline-block break-all">support@auditionease.com</a>
              </div>
            </div>
          </section>
