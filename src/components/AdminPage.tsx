        ...
        <table className="w-full">
          <thead>
            <tr className="bg-[#F9FAFB]">
              <th className="px-6 py-3 text-left text-xs font-bold text-[#6B7280] uppercase tracking-wider">ID</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-[#6B7280] uppercase tracking-wider">Name</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-[#6B7280] uppercase tracking-wider">Email</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-[#6B7280] uppercase tracking-wider">Joined</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#E5E7EB]">
            {stats.recentUsers.map((u) => (
              <tr key={u.id} className="hover:bg-[#F9FAFB] transition-colors">
                <td className="px-6 py-4 text-sm text-[#9CA3AF]">#{u.id}</td>
